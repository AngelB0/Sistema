    ...
    def Consultar():
        ...
        class TreeviewFrame(ttk.Frame):
            def __init__(self, *args, **kwargs):
                ...
                self.treeview.place(x=0, y=0, width=1265, height=580)
            ...
            def mostrar_info_ventass(self):
                ...
                self.btn_exportar_usuario.pack(side=tk.RIGHT, pady=40, anchor=tk.E, padx=30)
                self.btn_exportar_fecha.pack(side=tk.RIGHT, pady=40, anchor=tk.E, padx=30)
        ...
        #treeview_frame.place(x=0, y=0, width=1280, height=575)
