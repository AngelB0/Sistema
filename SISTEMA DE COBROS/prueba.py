...
def Inser_Alum():
 # Crear una ventana secundaria
    ...
    mat2 = tk.Entry(ventana_ins, width=10)
    mat2.place(x=135, y=70, width=80, height=20)

    #ALUMNO
    tk.Label(ventana_ins, text="ALUMNO", bg="white").place(x=250, y=70, width=80, height=20)
    alumno = tk.Entry(ventana_ins)
    ...
    #Boton Guardar
    boton_guardar = ttk.Button(ventana_ins, text="GUARDAR", command=SaveAlum)
...
def Inser_Concep():
     ...
     ventana_ins.config(width=800, height=300)
