...
open_eye = PhotoImage(file='visible.png')  # Ajusta la ruta y el nombre de la imagen
close_eye = PhotoImage(file='ojo.png')  # Ajusta la ruta y el nombre de la imagen
