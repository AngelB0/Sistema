...
def INDEX():
    ...
    def eliminar():
        ...
        window_delete.geometry("550x550")
        #window_delete.config(width=500, height=300)
        
        tk.Label(window_delete, text="Elija una Opción", font="Calibri 20 bold", bg=color_defondo, fg=color_letras_fon).pack(side=tk.TOP)

        # Crear un botón dentro de la ventana secundaria
         # para cerrar la misma.
        tk.Label(window_delete, text="ALUMNOS", font="Calibri 14 bold", bg=color_defondo, fg=c_negro).place(x=100, y=90)

        btn_Alumnos_del = tk.Button(window_delete,text="Eliminar la tabla \n completa de Alumnos",
                                    font="Candara 12 bold", 
                                    image=imgeliminar_tabla1, compound=TOP,
            bg=BG_botonE, fg="white", relief=tk.RAISED, bd=5,command=delete_Alum_com
        )
        btn_Alumnos_del_1 = tk.Button(window_delete,text="Eliminar 1 Registro \n de La tabla alumnos", 
                                      font="Candara 12 bold",
                                      image=imgeliminar_alum1, compound=TOP,
            bg=BG_botonA, fg="white", relief=tk.RAISED, bd=5,command=delete_Alum_Uno
        )
        #FUNCION ELIMINAR CONCEPTOS
        tk.Label(window_delete, text="CONCEPTOS", font="Calibri 14 bold", bg=color_defondo, fg=c_negro).place(x=350, y=90)
        btn_Conceptos_del = tk.Button(window_delete,text="Eliminar tabla \n completa de Conceptos",
                                      font="Candara 12 bold", 
                                      image=imgeliminar_tabla1, compound=TOP,
                                      bg=BG_botonE, fg="white", relief=tk.RAISED, bd=5, 
            command=delete_Concep_com
        )
        btn_Conceptos_del_1 = tk.Button(window_delete,text="Eliminar 1 Concepto ",
                                        font="Candara 12 bold",
                                        image=imge_concepto1, compound=TOP,
                                        bg=BG_botonA, fg="white", relief=tk.RAISED, bd=5, 
            command=delete_Concep_Uno
        )

        btn_cerrar_del = tk.Button(window_delete,text="Cerrar ventana", bg=regresar, fg="white", relief=tk.RAISED, bd=5, 
            command=window_delete.destroy
        )
        
        btn_cerrar_del.place(x=30, y=460, width=90, height=40)
        btn_Alumnos_del.place(x=30, y=150, width=200, height=120)
        btn_Alumnos_del_1.place(x=30, y=300, width=200, height=120)
        btn_Conceptos_del.place(x=310, y=150, width=200, height=120)
        btn_Conceptos_del_1.place(x=310, y=300, width=200, height=120)


        # Centrar la ventana en la pantalla
        window_delete.update_idletasks()
        width = window_delete.winfo_width()
        height = window_delete.winfo_height()
        x = (window_delete.winfo_screenwidth() // 2) - (width // 2)
        y = (window_delete.winfo_screenheight() // 2) - (height // 2)
        window_delete.geometry('{}x{}+{}+{}'.format(width, height, x, y))
    ...
    def actualizar():
        ...
        def act_Alum():
            ...
            window_alu.state('zoomed')

            #MATRICULA
            tk.Label(window_alu, text="MATRICULA:", bg=color_defondo, fg=c_negro).place(x=44, y=70, width=80, height=20)
            combobox_var = tk.StringVar()
            ...
            #ALUMNO
            tk.Label(window_alu, text="ALUMNO:",bg=color_defondo, fg=c_negro).place(x=36, y=100, width=80, height=20)
            alumno_a = tk.Text(window_alu, height=1, width=35, wrap=tk.NONE, bd=0, padx=2, pady=2)
            alumno_a.place(x=125, y=100)
            alumno_a.insert(tk.END, "")

            #OFERTA EDUCATIVA 
            tk.Label(window_alu, text="OFERTA EDUCATIVA:", bg=color_defondo, fg=c_negro).place(x=420, y=100, width=120, height=20)
            ofedu_a = tk.Text(window_alu, height=1, width=50, wrap=tk.NONE, bd=0, padx=2, pady=2)
            ofedu_a.place(x=545, y=100)
            ofedu_a.insert(tk.END, "")

            #PLANTEL
            tk.Label(window_alu, text="PLANTEL:", bg=color_defondo, fg=c_negro).place(x=690, y=130, width=75, height=20)
            plantel_a = tk.Text(window_alu, height=1, width=22, wrap=tk.NONE, bd=0, padx=2, pady=2)
            plantel_a.insert(tk.END, "")
            plantel_a.place(x=770, y=130)

            #GRADO
            tk.Label(window_alu, text="GRADO:",bg=color_defondo, fg=c_negro).place(x=50, y=130, width=40, height=20)
            grad_a = tk.Text(window_alu, height=1, width=2, wrap=tk.NONE, bd=0, padx=2, pady=2)
            grad_a.insert(tk.END, "")
            grad_a.place(x=100, y=130)

            #GRUPO
            tk.Label(window_alu, text="GRUPO:", bg=color_defondo, fg=c_negro).place(x=135, y=130, width=40, height=20)
            grup_a = tk.Text(window_alu, height=1, width=16, wrap=tk.NONE, bd=0, padx=2, pady=2)
            grup_a.insert(tk.END, "")
            grup_a.place(x=185, y=130)

            #PERIODO
            tk.Label(window_alu, text="PERIODO:",bg=color_defondo, fg=c_negro).place(x=335, y=130, width=50, height=20)
            perido_a = tk.Text(window_alu, height=1, width=15, wrap=tk.NONE, bd=0, padx=2, pady=2)
            perido_a.insert(tk.END, "")
            perido_a.place(x=395, y=130)

            #TURNO
            tk.Label(window_alu, text="TURNO:",bg=color_defondo, fg=c_negro).place(x=530, y=130, width=50, height=20)
            turno_al = tk.Text(window_alu, height=1, width=10, wrap=tk.NONE, bd=0, padx=2, pady=2)
            turno_al.insert(tk.END, "")
            turno_al.place(x=590, y=130)

            #FECHA DE INSCRIPCION
            tk.Label(window_alu, text="FECHA DE INSCRIPCION:", bg=color_defondo, fg=c_negro).place(x=50, y=160, width=133, height=20)
            inscripcion_a = tk.Text(window_alu, height=1, width=10, wrap=tk.NONE, bd=0, padx=2, pady=2)
            inscripcion_a.insert(tk.END, "")
            inscripcion_a.place(x=190, y=160)

            #ESTATUS
            tk.Label(window_alu, text="ESTATUS:", bg=color_defondo, fg=c_negro).place(x=285, y=160, width=80, height=20)
            estatus_a = tk.Text(window_alu, height=1, width=11, wrap=tk.NONE, bd=0, padx=2, pady=2)
            estatus_a.insert(tk.END, "")
            estatus_a.place(x=362, y=160)

            #FECHA ESTATUS
            tk.Label(window_alu, text="FECHA ESTATUS:", bg=color_defondo, fg=c_negro).place(x=475, y=160, width=90, height=20)
            festatus_a = tk.Text(window_alu, height=1, width=10, wrap=tk.NONE, bd=0, padx=2, pady=2)
            festatus_a.insert(tk.END, "")
            festatus_a.place(x=570, y=160)

            #Boton cerrar
            boton_cerrar = tk.Button(window_alu, text="Cerrar ventana",bg=regresar, fg="white", relief=tk.RAISED, bd=5, command=window_alu.destroy)
            boton_cerrar.place(x=50, y=300, width=90, height=40)

            #Boton guardar
            boton_guardar = tk.Button(window_alu, text="GUARDAR", bg=BG_botonA, fg="white", relief=tk.RAISED, bd=5, command= Save_Alum)
            boton_guardar.place(x=150, y=300, width=90, height=40)
        ...
        def act_Concep():
            ...
            window_con.state('zoomed')

            #CODIGO
            combobox_con = tk.StringVar()
            tk.Label(window_con, text="CODIGO:", bg=color_defondo, fg=c_negro).place(x=40, y=70, width=80, height=20)
            ...
            #CONCEPTO
            tk.Label(window_con, text="CONCEPTO:", bg=color_defondo, fg=c_negro).place(x=50, y=100, width=80, height=20)
            concepto_a = tk.Text(window_con, height=1, width=25, wrap=tk.NONE, bd=0, padx=2, pady=2)
            concepto_a.place(x=135, y=100)
            concepto_a.insert(tk.END, "")

            #CUENTA CONTABLE 
            tk.Label(window_con, text="CUENTA CONTABLE:",bg=color_defondo, fg=c_negro).place(x=350, y=100, width=120, height=20)
            contable_a = tk.Text(window_con, height=1, width=3, wrap=tk.NONE, bd=0, padx=2, pady=2)
            contable_a.place(x=475, y=100)
            contable_a.insert(tk.END,"")

            #COSTO
            tk.Label(window_con, text="COSTO:", bg=color_defondo, fg=c_negro).place(x=520, y=100, width=75, height=20)
            costo_a = tk.Text(window_con, height=1, width=8, wrap=tk.NONE, bd=0, padx=2, pady=2)
            costo_a.place(x=585, y=100)
            costo_a.insert(tk.END, "")

            #CLASIFICACION
            tk.Label(window_con, text="CLASIFICACION:", bg=color_defondo, fg=c_negro).place(x=50, y=130, width=100, height=20)
            clasificacion_a = tk.Text(window_con, height=1, width=15, wrap=tk.NONE, bd=0, padx=2, pady=2)
            clasificacion_a.place(x=160, y=130)
            clasificacion_a.insert(tk.END, "")

            #Boton cerrar
            boton_cerrar = tk.Button( window_con, text="Cerrar ventana",bg=regresar, fg="white", relief=tk.RAISED, bd=5, command=window_con.destroy)
            boton_cerrar.place(x=50, y=200, width=90, height=40)
            #Boton Guardar
            boton_guardar = tk.Button(window_con, text="GUARDAR", bg=BG_botonA, fg="white", relief=tk.RAISED, bd=5, command=save_Concep)
            boton_guardar.place(x=150, y=200, width=90, height=40)
            # Cierra la ventana principal
            mostrar_mat_con()
            ventana.withdraw()
        ...
        window_act.geometry("520x300+400+150")

        tk.Label(window_act, text="Elija una Opción", font="Calibri 20 bold", bg=color_defondo, fg=color_letras_fon).pack(side=tk.TOP, pady=50)
        ...
        btn_cerrar_act = tk.Button(
            ...
            text="Cerrar ventana", 
            font="Candara 12 bold",
            bg=color_letras_fon, fg="white", relief=tk.RAISED, bd=5, 
            command=window_act.destroy
        )
        
        btn_cerrar_act.place(x=30, y=250, width=120, height=40)
        btn_Alumnos_act.place(x=30, y=100, width=200, height=100)
        btn_Conceptos_act.place(x=260, y=100, width=210, height=100)
        # Cierra la ventana principal
        ventana.withdraw()
   ...
   #VENTANA PARA CONSULTAR
    def Consultar():
        ...
        class TreeviewFrame(ttk.Frame):
            ...
            def mostrar_info_ventass(self):
                ...
                self.treeview.config(columns=("folio","plantel", "matri", "nombre", "grupo", "licenciatura", "cant_recibe", "forma_p", "aprov", "cuenta_rec", "observasiones", "subtotal", "fecha", "concep","usuario", "estatus_fol"), show="headings")
                self.treeview.column('#0', width=0, stretch=tk.NO)
                ...
                self.treeview.column('estatus_fol', anchor=CENTER, width=100,stretch=tk.NO)
                self.treeview.heading('#0', text='', anchor=CENTER) 
                ...
                self.treeview.heading("estatus_fol", text="Estatus del Folio")
        ...
        # Crear un botón dentro de la ventana secundaria
        # para cerrar la misma.        
        btn_ventass = tk.Button(ventana_consul, text="Consultar Ventas", font="Candara 12 bold", bg=BG_botonC, fg="white", relief=tk.RAISED, bd=5, command=Consu_vent)    
        btn_Alumnos = tk.Button(ventana_consul, text="Consultar Alumnos", font="Candara 12 bold", bg=BG_botonC, fg="white", relief=tk.RAISED, bd=5, command=Consu_Alum)
        btn_Conceptos = tk.Button(ventana_consul,text="Consultar Conceptos",font="Candara 12 bold",bg=BG_botonC, fg="white", relief=tk.RAISED, bd=5, command=Consu_Concep)
        boton_regresar = tk.Button(ventana_consul,text="REGRESAR", font="Candara 12 bold", bg=regresar, fg="white", relief=tk.RAISED, bd=5, command=lambda:close_window(ventana_consul))
        ...
        boton_regresar.place(x=50, y=600, width=100, height=40)
        btn_Alumnos.place(x=180, y=600, width=150, height=40)
        btn_Conceptos.place(x=360, y=600, width=170, height=40)
        btn_ventass.place(x=560, y=600, width=150, height=40)
    ...
    def Insertar():
        ...
        #se le añade un titulo a la app
        ventana_INSERTAR.title("CARGAR REGISTROS")
        ventana_INSERTAR.geometry("550x300")

        men1=tk.Label(ventana_INSERTAR, text="Recuerde que solo se carga la tabla completa \n si desea ingresar un solo registro actualice su archivo de excel y luego cargelo", font="Calibri 12 bold", bg=color_defondo, fg="RED")
        men1.pack()
        
        tk.Label(ventana_INSERTAR, text="Elija una Opción", font="Calibri 16 bold", bg=color_defondo, fg=color_letras_fon).pack(side=tk.TOP, pady=30)
        # Crear un botón dentro de la ventana secundaria
        # para cerrar la misma.
        btn_Alumnos_insert = tk.Button(
            ...
            image=imgnuevoa1,
            compound=TOP,
            bg=BG_botonI, fg="white", relief=tk.RAISED, bd=5, 
        ...
        btn_cerrar_insert = tk.Button(
            ...
            text="REGRESAR",
            font="Candara 12 bold",
            bg=regresar, fg="white", relief=tk.RAISED, bd=5, 
            command=ventana_INSERTAR.destroy
        )

        btn_cerrar_insert.place(x=30, y=250, width=100, height=40)
        btn_Alumnos_insert.place(x=30, y=120, width=220, height=100)
        btn_Conceptos_insert.place(x=280, y=120, width=230, height=100)

        
        # Centrar la ventana en la pantalla
        ventana_INSERTAR.update_idletasks()
        width = ventana_INSERTAR.winfo_width()
        height = ventana_INSERTAR.winfo_height()
        x = (ventana_INSERTAR.winfo_screenwidth() // 2) - (width // 2)
        y = (ventana_INSERTAR.winfo_screenheight() // 2) - (height // 2)
        ventana_INSERTAR.geometry('{}x{}+{}+{}'.format(width, height, x, y))
    ...
    def CANCELAR_FOLIO():
        ...
        def on_key_release_FolioCancelar(event):
                    number = mostrar_FOLIO()
                    try:
                        value = int(combobox_variable_fol.get())
                        filtered_values = [item for item in number if str(value) in str(item)]

                    except ValueError:
                        filtered_values = []

                    folio_entry['values'] = filtered_values

        def mostrar_FOLIO():
            # Obtener las opciones de la base de datos
            opciones_bd_FOL = obtener_folio_bd()
            # Limpiar el ComboBox
            folio_entry['values'] = ()
            # Configurar las nuevas opciones en el ComboBox
            folio_entry['values'] = [opcion[0] for opcion in opciones_bd_FOL]
            
            number_list4 = folio_entry['values'] = [opcion[0] for opcion in opciones_bd_FOL]
            
            return number_list4
            #mat.configure(values=[opcion[0] for opcion in opciones_bd_mat])

        def accion_al_seleccionar_FolioCancelacion(event):
            # Obtener el valor seleccionado del Combobox
            primary_key_fol = int(combobox_variable_fol.get())
            ...
            consulta = "UPDATE ventas SET estatus_fol = %s WHERE folio = %s"
            nuevo_valor = "CANCELADO"  # Cambia esto por el nuevo valor que deseas asignar
            try:
                cur.execute(consulta, (nuevo_valor, primary_key_fol))

                # Confirmar los cambios
                conn.commit()

                # Mostrar un mensaje de éxito
                messagebox.showinfo("Éxito", "Se cancelo correctamente el Folio.")
            except psycopg2.Error as e:
                # Mostrar un mensaje de error si algo salió mal
                messagebox.showerror("Error", f"No se pudo cancelar el folio: {e}")

            # Cerrar la conexión
            conn.close()
            ventana_confirmacion2.destroy


        ventana_confirmacion2 = tk.Toplevel(WIND)
        ventana_confirmacion2.title("Cancelar Folio")
        # Etiqueta con el mensaje
        mensaje_label = tk.Label(ventana_confirmacion2, text="Introduzca el folio que desea cancelar")
        mensaje_label.grid(row=0, column=0, columnspan=2, padx=20, pady=20)

        combobox_variable_fol = tk.StringVar()
        folio_entry = ttk.Combobox(ventana_confirmacion2, width=30, font="Candara 12 bold", textvariable=combobox_variable_fol)
        # Vincular la función al evento <<ComboboxSelected>>
        folio_entry.bind("<<ComboboxSelected>>", accion_al_seleccionar_FolioCancelacion)
        folio_entry.bind('<KeyRelease>', on_key_release_FolioCancelar)
        folio_entry.grid(row=1, column=0, columnspan=2, padx=20, pady=20)

        # Botón "Sí" que realiza una acción y cierra la ventana
        boton_si = tk.Button(ventana_confirmacion2, text="Sí", bg="#9BD8FF", fg="black", relief=tk.RAISED, bd=5, command=lambda: accion_al_seleccionar_FolioCancelacion,  width=15)
        boton_si.grid(row=2, column=0, padx=10, pady=10)

        # Botón "No" que cierra la ventana sin realizar ninguna acción
        boton_no = tk.Button(ventana_confirmacion2, text="No", bg="#FF4C5C", fg="black", relief=tk.RAISED, bd=5, command=ventana_confirmacion2.destroy, width=15)
        boton_no.grid(row=2, column=1, padx=10, pady=10)

        # Cambiar el tamaño de la ventana
        ventana_confirmacion2.geometry('340x200')
        # Centrar la ventana en la pantalla
        ventana_confirmacion2.update_idletasks()
        width = ventana_confirmacion2.winfo_width()
        height = ventana_confirmacion2.winfo_height()
        x = (ventana_confirmacion2.winfo_screenwidth() // 2) - (width // 2)
        y = (ventana_confirmacion2.winfo_screenheight() // 2) - (height // 2)
        ventana_confirmacion2.geometry('{}x{}+{}+{}'.format(width, height, x, y))
        mostrar_FOLIO()
    
    def on_enter(e):
        e.widget.config(bg='yellow')  # Cambia el color de fondo al pasar el cursor por encima
        e.widget.config(padx=2, pady=2)  # Aumenta el padding

    def on_leave(e):
        e.widget.config(bg=color_defondo)  # Restaura el color de fondo al salir del botón
        e.widget.config(padx=0, pady=0)  # Restaura el padding
    ...
    reinprimir_button = tk.Button(WIND, text="Reinprimir Recibo", font=("Arial 8 bold"), image=imgLUPA1, compound=LEFT, bg=color_defondo, fg="black", relief=tk.RAISED, bd=3, command=REIMPRIMIR_RECIBO)
    reinprimir_button.place(x=828, y=140, width=150, height=30)

    # Botón para guardar datos en el PDF
    #tk.Label(WIND, text="IMPRIMIR",  bg=color_defondo, relief=tk.FLAT, fg="black", font="Candara 8 bold").place(x=875, y=200, width=50, height=20)
    guardar_pdf_button = tk.Button(WIND, text="Guardar PDF", font=("Arial 8 bold"), image=imgPDF1, compound="top", bg=color_defondo, fg="black",relief=tk.RAISED, bd=3,  command=confirmacion_pdf)
    guardar_pdf_button.place(x=950, y=220, width=80, height=60)
    ...
    BTN_LIMPIAR = tk.Button(WIND, text="Limpiar campos", font=("Arial 8 bold"), image=imgg1, compound=TOP, bg=color_defondo, fg="black", relief=tk.RAISED, bd=3, command=LIMPIAR_DATOS)
    BTN_LIMPIAR.place(x=830, y=220, width=100, height=50)

    #BOTON PARA CANCELAR FOLIO
    BTN_CANCELAR = tk.Button(WIND, text="Cancelar Folio", font=("Arial 8 bold"), image=imgcancelar1, compound=TOP, bg=color_defondo, fg="black", relief=tk.RAISED, bd=3, command=CANCELAR_FOLIO)
    BTN_CANCELAR.place(x=1080, y=220, width=90, height=60)
    ...
    boton_enviar = tk.Button(WIND, text="REGISTRAR", bg=BG_botonR, fg="white",image=imgregistrar1, compound=LEFT, relief=tk.RAISED, bd=5,font="Candara 15 bold", command=enviar_datos)
    boton_enviar.place(x=900, y=495, width=150, height=40)

    btn_Consultar = tk.Button(WIND, text="CONSULTAR", bg=BG_botonC, fg="white", image=imgbuscar1, compound=LEFT, relief=tk.RAISED, bd=5,font="Candara 15 bold", command=Consultar)
    btn_Consultar.place(x=50, y=by, width=150, height=40)

    btn_Insert = tk.Button(WIND, text="SUBIR", bg=BG_botonI, fg="white",image=imgsubir1, compound=LEFT, relief=tk.RAISED, bd=5,font="Candara 15 bold", command=Insertar)
    btn_Insert.place(x=230, y=by, width=150, height=40)

    btn_Actualizar = tk.Button(WIND, text="ACTUALIZAR",image=imgactualizar1, compound=LEFT, bg=BG_botonA, fg="white", relief=tk.RAISED, bd=5,font="Candara 15 bold", command=actualizar)
    btn_Actualizar.place(x=410, y=by, width=150, height=40)

    btn_eliminar = tk.Button(WIND, text="ELIMINAR", bg=BG_botonE,image=imgborrar1, compound=LEFT, fg="white", relief=tk.RAISED, bd=5,font="Candara 15 bold", command=eliminar)
    btn_eliminar.place(x=590, y=by, width=150, height=40)

    #CERRAR SESION
    #tk.Label(WIND, text="CERRAR SESIÓN",  bg="#565151", relief=tk.GROOVE, bd=3, fg="white", font="Candara 10 bold").place(x=1150, y=530, width=110, height=20)
    btn_cerrar_sesion = tk.Button(WIND, text="CERRAR SESIÓN", font="Candara 10 bold", image=imgSES1, compound=BOTTOM, bg=color_defondo, fg="black", relief=FLAT, bd=3, command=cerrar_sesion)
    btn_cerrar_sesion.place(x=1150, y=550, width=100, height=80)

    # Asocia los eventos <Enter> y <Leave> al botón
    guardar_pdf_button.bind('<Enter>', on_enter)
    guardar_pdf_button.bind('<Leave>', on_leave)
    reinprimir_button.bind('<Enter>', on_enter)
    reinprimir_button.bind('<Leave>', on_leave)
    BTN_LIMPIAR.bind('<Enter>', on_enter)
    BTN_LIMPIAR.bind('<Leave>', on_leave)
    btn_cerrar_sesion.bind('<Enter>', on_enter)
    btn_cerrar_sesion.bind('<Leave>', on_leave)
...
b1.grid(columnspan=2, row=6, padx=4, pady=10)
...
imgLUPA1 = imgLUPA.subsample(3,3)

imgbuscar = PhotoImage(file='img/lupa.png')
imgbuscar1 = imgbuscar.subsample(5,5)

#ventana consultar

imgcalum= PhotoImage(file='img/calumno.png')
imgcalum1=imgcalum.subsample(8,8)

imgconconceptos=PhotoImage(file='img/con_concepto.png')
imgconconceptos1=imgconconceptos.subsample(8,8)

imgcventas=PhotoImage(file="img/cventa.png")
imgcventas1=imgcventas.subsample(8,8)

imgregresar= PhotoImage(file='img/regresar.png')
imgregresar1=imgregresar.subsample(8,8)

imgsubir=PhotoImage(file='img/subir.png')
imgsubir1=imgsubir.subsample(5,5)

imgactualizar=PhotoImage(file='img/actualizar.png')
imgactualizar1 = imgactualizar.subsample(5,5)

imgborrar=PhotoImage(file='img/borrar.png')
imgborrar1=imgborrar.subsample(5,5)

imgcancelar=PhotoImage(file="img/cancelar.png")
imgcancelar1=imgcancelar.subsample(8,8)

imgregistrar=PhotoImage(file='img/archivo.png')
imgregistrar1=imgregistrar.subsample(5,5)

#Ventana Subir
imgnuevoa=PhotoImage(file='img/anadir_alumno.png')
imgnuevoa1=imgnuevoa.subsample(2,2)

imgnuevocon=PhotoImage(file='img/nuevos_conceptos.png')
imgnuevocon1=imgnuevocon.subsample(2,2)

#ventana actualizar
imgactalum=PhotoImage(file='img/editar_alum.png')
imgactalum1=imgactalum.subsample(2,2)

imgactconcep=PhotoImage(file='img/editar_concepto.png')
imgactconcep1=imgactconcep.subsample(2,2)

#Ventana Eliminar
imgeliminar_tabla=PhotoImage(file='img/eliminar_tabla.png')
imgeliminar_tabla1=imgeliminar_tabla.subsample(2,2)

imgeliminar_alum=PhotoImage(file='img/eliminar_alum.png')
imgeliminar_alum1=imgeliminar_alum.subsample(2,2)

imge_concepto=PhotoImage('img/eliminar_concepto.png')
imge_concepto1=imge_concepto.subsample(2,2)
...
eye_button.grid(columnspan=2, row=4, padx=(260, 10)) # Ajusta las coordenadas según sea necesario
