    ...
    def Consultar():
        ...
        class TreeviewFrame(ttk.Frame):
            def __init__(self, *args, **kwargs):
                ...
                self.combo_exportar = ctk.CTkComboBox(self, values=["Descargar todas las Ventas", "Descargar solo por Usuario", "Descargar solo por Fecha"], command=self.ejecutar_funcion_seleccionada,
                                                      state="readonly",
                                                      hover=True,
                                                      height=28,
                                                      width=250,
