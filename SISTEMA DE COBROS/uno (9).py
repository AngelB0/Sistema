...
def INDEX():
   ...
   #VENTANA PARA CONSULTAR
    ...
    guardar_pdf_button = tk.Button(WIND, text="Imprimir", font=("Arial 8 bold"), image=imgREIMPRI1, compound="top", bg=color_defondo, fg="black",relief=tk.RAISED, bd=3,  command=confirmacion_pdf)
    guardar_pdf_button.place(x=980, y=220, width=60, height=50)
    ...
    BTN_LIMPIAR.place(x=850, y=220, width=100, height=50)
    ...
    boton_enviar.place(x=920, y=495, width=120, height=40)
...
imgPDF1 = imgPDF.subsample(10, 10)
