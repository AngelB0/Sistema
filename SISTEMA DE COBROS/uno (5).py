...
def INDEX():
   ...
   #VENTANA PARA CONSULTAR
    ...
    # Obtiene los datos del formulario
        ...
        "Recargos": [rec1.get(), rec2.get(), rec3.get(), rec4.get(), rec5.get(), rec6.get(), rec7.get()],
    ...
    def crear_pdf(datos, nombre_pdf, pdf_existente):
       ...
       # Verificar si la licenciatura es larga y reemplazar con la versión corta
        ...
        for i in range(5):
            ...
            pagina.insert_text((415, y_arriba), f"{datos['Recargos'][i]}")
        ...
        for i in range(5):
            ...
            pagina.insert_text((415, y_abajo), f"{datos['Recargos'][i]}")
